<template>
  <q-layout view="lHr lpR fFf">
      ...
      <q-toolbar>
        ...
        <q-toolbar-title class="text-weight-bold">
          <span class="gt-sm">{{ $route.name }}</span>
           <q-icon class="q-pa-md lt-md header-icon" size="sm" color="primary" name="fas fa-dove"></q-icon>
        </q-toolbar-title>
    ...
    <q-drawer show-if-above v-model="left" side="left" bordered :width="283">
      <q-icon class="q-pa-md" size="lg" color="primary" name="fas fa-dove"></q-icon>

      <q-list>
        <q-item to="/" clickable v-ripple exact>
          <q-item-section avatar>
            <q-icon color="primary" name="home" size="md"></q-icon>
          </q-item-section>
    ...
    <q-drawer show-if-above v-model="right" side="right" bordered>
      <q-input class="q-ma-md" outlined rounded placeholder="Search Qwitter" dense>
       ...
       <q-list padding separator>
         <q-item class="q-pa-md">
           <q-item-section>
             ...
             <q-item-label class="text-weight-bold">Something amaxing happened!</q-item-label>
